...
<head>
    <meta charset="utf-8">
    <title>Decorators - Design Studio HTML Template | Our Blog</title>
    <!-- Stylesheets -->
                ...
                <div class="auto-container">
                    <div class="outer-container clearfix">
                        ...
                        <a href="shopping-cart.html" class="cart-btn-outer">
                            <div class="icon"><span class="flaticon-shopping-bag"></span><span class="count">2</span>
                            </div>
                        </a>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <?php
                        include 'config.php';
                        $data_dews = mysqli_query($conn, "SELECT * FROM news");
                        if(mysqli_num_rows($data_dews) > 0){
                            while($fetch_news = mysqli_fetch_assoc($data_dews)){
                                $id = $fetch_news['id'];
                                ...
                                <div class="inner-box">
                                    <div class="row clearfix">
                                        <div class="image-column col-md-3 col-sm-4 col-xs-12">
                                            <figure class="image-box"><img src="admin/assets/img/news/<?= $image ?>"
                                                    alt=""><a class="overlay-link" href="blog-single.html"><span
                                                        class="icon flaticon-plus-1"></span></a></figure>
                                        </div>
                                        <div class="content-column col-md-7 col-sm-6 col-xs-12">
                                            <div class="content">
                                                <h3><a href="blog-single.html"><?= $title ?></a>
                                                </h3>
                                                <ul class="post-meta clearfix">
                                                    <li><a href="#"><span class="icon fa fa-clock-o"></span><?= $newDate ?></a></li>
                                                    <li><a href="#"><span class="icon fa fa-tags"></span> <?= $category ?></a>
                                                    </li>
                    ...
                    <div class="sidebar-side col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <aside class="sidebar">
                            ...
                            <!-- Archives -->
                            <div class="widget text-widget sidebar-widget">
                                <div class="sidebar-title">
                                    <h3>Text Widget</h3>
                                </div>

                                <div class="text">
                                    <p>We know give much more satisfaction to our customers, with high quality products
                                        and great services. </p>
                                    <p>We Decorators is the leading interior design organization in <a href="#">USA</a>.
                                        We doing this service with great experince and High knowledge <a
                                            href="#">Experts</a>. </p>
                                </div>
        ...
        <footer class="main-footer" style="background-image:url(images/background/footer-bg.jpg);">
                                ...
                                <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                                    <div class="footer-widget about-widget">
                                        <div class="footer-logo">
                                            <figure><a href="index-2.html"><img src="images/logo-4.png" alt=""></a>
                                            </figure>
                                        </div>
                                        <div class="widget-content">
                                            <div class="text">Must explain too you all this mistaken idea off denouncing
                                                pleasure and well praising pain was born and I will gives you complete
                                                accounts systems must explain to idea of denouncing.</div>
                                            <ul class="contact-info">
                                                <li><span class="icon fa fa-map-marker"></span>Rock St 12, Newyork City,
                                                    USA</li>
                                                <li><span class="icon fa fa-phone"></span>(526) 236-895-4732</li>
                                                <li><span
                                                        class="icon fa fa-envelope-o"></span>Decoratorssuport@gmail.com
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="footer-widget gallery-widget">
                                        ...
                                        <div class="gallery-widget-carousel">
                                            <div class="item">
                                                <figure class="post-thumb"><img src="images/gallery/thumb-1.jpg"
                                                        alt=""><a href="#" class="overlay-link"><span
                                                            class="fa fa-link"></span></a></figure>
                                            </div>
                                            <div class="item">
                                                <figure class="post-thumb"><img src="images/gallery/thumb-2.jpg"
                                                        alt=""><a href="#" class="overlay-link"><span
                                                            class="fa fa-link"></span></a></figure>
                                            </div>
                                            <div class="item">
                                                <figure class="post-thumb"><img src="images/gallery/thumb-3.jpg"
                                                        alt=""><a href="#" class="overlay-link"><span
                                                            class="fa fa-link"></span></a></figure>
                                            </div>
                                            <div class="item">
                                                <figure class="post-thumb"><img src="images/gallery/thumb-4.jpg"
                                                        alt=""><a href="#" class="overlay-link"><span
                                                            class="fa fa-link"></span></a></figure>
                                            </div>
                                            <div class="item">
                                            ...
                                            <div class="posts">
                                                <div class="post">
                                                    <figure class="post-thumb"><img
                                                            src="images/resource/post-thumb-1.jpg" alt=""><a href="#"
                                                            class="overlay-link"><span
                                                                class="flaticon-plus-1"></span></a></figure>
                                                    <div class="desc-text"><a href="#">How mistakens denoncings pleasure
                                                            and complete.</a></div>
                                                    <div class="time"><span class="fa fa-clock-o"></span> Oct 03, 2015
                                                    </div>
                                                </div>
                                                <div class="post">
                                                    <figure class="post-thumb"><img
                                                            src="images/resource/post-thumb-2.jpg" alt=""><a href="#"
                                                            class="overlay-link"><span
                                                                class="flaticon-plus-1"></span></a></figure>
                                                    <div class="desc-text"><a href="#">Pleasure praising pains was,
                                                            expound actual teaching.</a></div>
                                                    <div class="time"><span class="fa fa-clock-o"></span> Aug 21, 2015
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="clearfix">
                        <div class="pull-left">
                            <div class="copyright"><a href="https://www.templateshub.net" target="_blank">Templates
                                    Hub</a></div>
                        </div>
                        <div class="pull-right">
                            <ul class="footer-nav">
