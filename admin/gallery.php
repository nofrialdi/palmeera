...
$result = mysqli_query($koneksi, "SELECT * FROM gallery");
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div><a href="gallery/addGallery.php" type="button"  class="btn btn-primary"> <i class="fas fa-image"></i> Add Gallery</a></div>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?= $i++ ?></td>
                            <td><img src="assets/img/gallery/<?= $row['image'] ?>" width="100px" height="100px"></td>
                            <td><?= base64_decode($row['description']) ?></td>
                            <td>
                                <a href="gallery/editGallery.php?id=<?= $row['id'] ?>" class="btn btn-success">Edit</a>
                                <a href="gallery/deleteGallery.php?id=<?= $row['id'] ?>" class="btn btn-danger">Delete</a>
                            </td>
                          </tr>
                          <?php endwhile;  ?>
                        </tbody>
