...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE gallery SET image = '$new_image_name', description = '$description' WHERE id = $id";
                ...
                <div class="card">
                  ...
                  <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <img src="../assets/img/gallery/<?= $data['image'] ?>" alt="" width="100px" height="100px">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea class="summernote" name="description" id="description" require><?= base64_decode($data['description']) ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
