...
$data_news = mysqli_query($koneksi, "SELECT * FROM news");
$jumlah_news = mysqli_num_rows($data_news);

$data_message = mysqli_query($koneksi, "SELECT * FROM message");
$jumlah_message = mysqli_num_rows($data_message);

$data_partnership = mysqli_query($koneksi, "SELECT * FROM partnership");
$jumlah_partnership = mysqli_num_rows($data_partnership);

$data_gallery = mysqli_query($koneksi, "SELECT * FROM gallery");
$jumlah_gallery = mysqli_num_rows($data_gallery);
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Total News</h5>
                          <h2 class="mb-3 font-18"><?php echo $jumlah_news ?></h2>
                        </div>
                      </div>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15"> Total Patnership</h5>
                          <h2 class="mb-3 font-18"><?php echo $jumlah_partnership ?></h2>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15"> Total Gallery</h5>
                          <h2 class="mb-3 font-18"><?php echo $jumlah_gallery ?></h2>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Total Newsletter</h5>
                          <h2 class="mb-3 font-18"><?php echo $jumlah_newsletter ?></h2>
                        
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img src="assets/img/banner/newsletter.png" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
