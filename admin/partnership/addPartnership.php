              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body"> 
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" for="category">Country</label>
                      <div class="col-sm-12 col-md-7">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="email" class="form-control" name="contact_person" id="email" require>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >Registraton Date</label>
                      <div class="col-sm-12 col-md-7">
                      <label class="col-form-label  "><?php echo date('d-m-Y');?> </label>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="file" class="form-control" name="company_logo" id="company_logo" require>
                      </div>
                    </div>
